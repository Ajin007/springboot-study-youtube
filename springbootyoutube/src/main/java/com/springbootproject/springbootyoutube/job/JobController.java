...
public class JobController {
    ...
    //@ Responseentity class added so that we shall easily add on the response values using the Httpstatus method
    //Responseentity is the best way to keep the code in the controller section maintainable and keep it clear for other co developers.
    @GetMapping("/jobs/{id}")
